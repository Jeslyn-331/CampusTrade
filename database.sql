...
(2, 'Calculus Early Transcendentals 8th Ed', 'James Stewart textbook used for UECM1024. Minor highlighting in chapters 1-3, otherwise clean. No missing pages.', 45.00, 'Textbooks', 'Good', 'Available', 'calculus.webp', NOW() - INTERVAL 2 DAY),
(2, 'Casio FX-570EX Scientific Calculator', 'Approved model for UTAR exams. Fully working, comes with cover. Selling because I graduated.', 35.00, 'Electronics', 'Like New', 'Available', 'casio_calculator.webp', NOW() - INTERVAL 3 DAY),
(3, 'IKEA Study Desk (LINNMON)', '100x60cm white desk, sturdy legs. Perfect for hostel room. Self collect at Westlake condo.', 80.00, 'Furniture', 'Good', 'Available', 'ikea_desk.webp', NOW() - INTERVAL 4 DAY),
(3, 'Fundamentals of Database Systems 7th Ed', 'Elmasri & Navathe. Required for UECS2084. Very good condition, no writing inside.', 50.00, 'Textbooks', 'Like New', 'Available', 'database_system_book.webp', NOW() - INTERVAL 5 DAY),
(4, 'Logitech M185 Wireless Mouse', 'Reliable wireless mouse with USB receiver. Battery included. Used for one semester only.', 25.00, 'Electronics', 'Like New', 'Available', 'logitect_mouse.webp', NOW() - INTERVAL 6 DAY),
(4, 'Lab Coat Size M', 'White lab coat required for chemistry/biology labs. Washed and ironed. Worn fewer than 10 times.', 20.00, 'Clothing', 'Good', 'Available', 'labcoat.webp', NOW() - INTERVAL 7 DAY),
(5, 'Acer Aspire 5 Laptop (i5, 8GB, 512GB)', 'Reliable laptop for programming and assignments. Battery health ~85%. Comes with charger and sleeve. Reason for selling: upgraded.', 1250.00, 'Electronics', 'Good', 'Available', 'acer_laptop.webp', NOW() - INTERVAL 8 DAY),
...
(5, 'Office Chair with Wheels', 'Adjustable height office chair, comfortable for long study sessions. Small scratch on armrest.', 65.00, 'Furniture', 'Fair', 'Available', 'ofiice_chair.webp', NOW() - INTERVAL 13 DAY),
